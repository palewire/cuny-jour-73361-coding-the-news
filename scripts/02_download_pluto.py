...
while True:
    ...
    page_url = f"{url}?$select=bbl,latitude,longitude&$limit={page_size}&$offset={offset}"
...
pluto.to_csv("output/pluto_raw.csv", index=False)

# Tell the user where the file was saved
print(f"Saved {len(pluto):,} rows to output/pluto_raw.csv")
